...
train.data <- read.csv("C:/Users/00008020/Desktop/R_projects/data_excel/DataSet_credit_risk/R_Module_Day_7.2_Credit_Risk_Train_data.csv")

test.data <- read.csv("C:/Users/00008020/Desktop/R_projects/data_excel/DataSet_credit_risk/R_Module_Day_8.1_Credit_Risk_Test_data.csv")
...
pr <- prediction(p, train_subset$Loan_Status)#prediction-function,not same as predict
prf <- performance(pr, measure = "tpr", x.measure = "fpr")#tpr-true positive rate,fpr-false positive rate.performance:function
plot(prf)
