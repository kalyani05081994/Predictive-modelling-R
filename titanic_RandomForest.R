...
train <- read.csv("C:/Users/00008020/Desktop/R_projects/data_excel/train.csv")
test <- read.csv("C:/Users/00008020/Desktop/R_projects/data_excel/test.csv")
...
summary(combi)
#backfilling :for na in age column age prediction is done using other parameters and the predicted values are backfilled into age column in train data set
